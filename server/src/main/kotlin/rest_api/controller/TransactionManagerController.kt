...
class TransactionManagerController(private val transactionManagerService: TransactionManagerService){
    ...
    suspend fun submitTransaction(@RequestBody body: Transaction, @PathVariable address: String): String = transactionManagerService.submitTransaction(body, address)
